  ...
  return (
    <form className="flex flex-col w-[292px]">
      ...
      <div className="flex flex-col gap-2 mb-6">
        <select className="border border-gray-200 bg-gray-300 rounded-[14px] px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-400 text-gray-700">
      ...
      <div className="flex w-full gap-2 mb-6">
        <input
          ...
          className="w-2/3 border border-gray-200 bg-gray-300 rounded-[14px] px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-400 placeholder:text-black/50 placeholder:text-body-1-semibold"
          value={userId}
      ...
      <input type="password" placeholder="비밀번호를 입력하세요" className="border border-gray-200 bg-gray-300 rounded-[14px] px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-400 placeholder:text-black/50 placeholder:text-body-1-semibold mb-6" />
      {/* 비밀번호 재확인 */}
      <label className="text-body-2-semibold mb-1 flex">비밀번호 재확인</label>
      <input type="password" placeholder="비밀번호를 다시 입력하세요" className="border border-gray-200 bg-gray-300 rounded-[14px] px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-400 placeholder:text-black/50 placeholder:text-body-1-semibold" />
      {/* 회원가입 버튼 */}
      <button type="submit" className="bg-blue-500 text-white py-3 rounded-[14px] font-bold mt-14 hover:bg-blue-600 transition cursor-pointer">회원가입하기</button>
    </form>
  );
};
